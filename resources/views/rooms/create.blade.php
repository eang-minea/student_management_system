    ...
    <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-xl">
        <div class="md:flex">
            <div class="w-full px-6 py-8 md:p-8">
                <h2 class="text-2xl font-bold text-gray-800">CreateRoom</h2>
                <p class="mt-4 text-gray-600">Please fill out the form below to create a new room.</p>
                <form class="mt-6" method="POST" action="/rooms">
                    @csrf
